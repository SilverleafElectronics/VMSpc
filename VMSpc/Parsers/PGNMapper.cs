...
namespace VMSpc.Parsers
{
    ...
    static class PGNMapper
    {
        ...
        static PGNMapper()
        {
            PGNMap = new Dictionary<uint, byte[]>
            {
                { 0x0F005, new TSPNDatum[] { spn_rangeSelected, spn_rangeAttained } },
                { 0x0F004, new TSPNDatum[] { spn_torquePercent, spn_rpms } },
                { 0x0F003, new TSPNDatum[] { spn_percentAcceleratorPosition, spn_loadPercent }  },
                { 0x0F000, new TSPNDatum[] { spn_retarderPercent } },
                { 0x0F001, new TSPNDatum[] { spn_absActive } },
                { 0x0FEF1, new TSPNDatum[] { spn_cruiseSpeed, spn_roadSpeed } },
                { 0x0FEF2, new TSPNDatum[] { spn_fuelRate, spn_instantMPG, spn_reciprocalMPG } },
                { 0x0FEF5, new TSPNDatum[] { spn_baroPressure, spn_ambientTemp, spn_airInletTemp } },
                { 0x0FEFC, new TSPNDatum[] { spn_fuelLevel } },
                { 0x0FEEE, new TSPNDatum[] { spn_coolantTemp, spn_fuelTemp, spn_oilTemp, spn_interCoolerTemp } },
                { 0x0FEF6, new TSPNDatum[] { spn_turboBoost, spn_intakeTemp, spn_airInletPressure, spn_airFilterDiffPressure, spn_exhaustTemp173 } },
                { 0x0FEF7, new TSPNDatum[] { spn_voltage } },
                { 0x0FEEF, new TSPNDatum[] { spn_fuelPressure, spn_oilLevel, spn_oilPSI, spn_crankCasePressure, spn_coolantPressure, spn_coolantLevel } },
                { 0x0FEC1, new TSPNDatum[] { spn_odometer } },
                { 0x0FEE9, new TSPNDatum[] { spn_fuelMeter } },
                ...
                { 0xFD7C,  new TSPNDatum[] { spn_dpfLamp, spn_dpfActiveStatus, spn_dpfInibitClutch, spn_dpfInhibitSwitch, spn_dpfInhibitStatus, spn_dpfInhibitSpeed, spn_dpfInhibitOffidle
